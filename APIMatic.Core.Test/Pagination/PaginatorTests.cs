...
{
    [TestFixture]
    public class PaginatorTests : ApiCallTest
    {
        [Test]
        ...
        [Test]
        public void Paginate_QueryOffsetPagination_YieldsNoItems()
        {
            // Arrange
            const int limit = 2;
            ...
            var paginator = PaginationFactory.CreateHandler(
        ...
        [Test]
        public void Paginate_QuerySinglePagination_YieldsFirstPageItemsOnly()
        {
            // Arrange
            const int limit = 2;
